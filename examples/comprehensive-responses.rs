// Example: Comprehensive Response Types with Toxi
...
async fn html_page(_req: Request) -> Result<Response> {
    ...
    <body>
        <div class="container">
            ...
            <p>This is an HTML response generated by Toxi.</p>
            <ul>
...
async fn text_response(_req: Request) -> Result<Response> {
    Ok(Response::text("This is a plain text response from Toxi!".to_string()))
}
...
async fn main() -> Result<()> {
    ...
    println!("  http://127.0.0.1:3000/users/123 - Path parameter example");
