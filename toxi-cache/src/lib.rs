//! # Toxi Cache
//!
//! Multi-backend caching for Toxi applications.
//!
//! Provides an async `Cache` trait with in-memory and Redis implementations.
//! Supports TTL-based expiration, namespace isolation, and cache statistics.
//!
//! ## Backends
//!
//! | Backend     | Module    | Use Case                              |
//! |-------------|-----------|----------------------------------------|
//! | Memory      | Default   | Development, single-instance apps      |
//! | Redis       | [`redis`] | Distributed caching, multi-instance    |
//!
//! ## Quick Start
//!
//! ```rust,ignore
