...
use crate::{Router, ToxiRequest, ToxiResponse};
...
impl VersionedRouter {
    ...
    pub fn extract_version(&self, req: &ToxiRequest) -> ApiVersion {
        // Try URL path first
...
impl DeprecationMiddleware {
    ...
    pub fn add_headers(&self, version: ApiVersion, response: &mut ToxiResponse) {
