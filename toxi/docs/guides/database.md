...
Complete guide to using the Toxi ORM for database operations.

## Installation

```toml
[dependencies]
toxi = { version = "1.0", features = ["database"] }
```
...
```toml
[dependencies]
toxi = "1.0"  # Includes database features
```
