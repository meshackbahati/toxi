//! # Toxi Storage
//!
//! Unified file storage abstraction for Toxi applications.
//!
//! Supports local filesystem and S3-compatible backends (AWS S3, MinIO,
//! Cloudflare R2) through a common `Storage` trait.
//!
//! ## Backends
//!
//! | Backend | Module | Use Case                        |
//! |---------|--------|----------------------------------|
//! | Local   | [`local`] | Development, single-server     |
//! | S3      | [`s3`]    | Production, distributed storage |
//!
//! ## Quick Start
//!
//! ```rust,ignore
...
//! storage.put("avatars/user.jpg", file_bytes).await?;
//! let data = storage.get("avatars/user.jpg").await?;
//! ```
...
/// File validation utilities (size, type, name sanitization).
pub mod validation;
