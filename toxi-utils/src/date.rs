...
//!
//! ```rust
//! use toxi_utils::date::{now, format_date, unix_timestamp};
//!
...
///
/// ```rust
/// use toxi_utils::date::{now, format_date};
///
/// let formatted = format_date(&now(), "%Y-%m-%d");
/// assert_eq!(formatted.len(), 10);
/// ```
...
///
/// ```rust
/// use toxi_utils::date::parse_date;
///
...
///
/// ```rust
/// use toxi_utils::date::unix_timestamp;
///
...
///
/// ```rust
/// use toxi_utils::date::unix_timestamp_millis;
///
...
///
/// ```rust
/// use toxi_utils::date::{unix_timestamp, is_expired};
///
