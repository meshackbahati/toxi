...
//!
//! ```rust
//! use toxi_utils::string::{slugify, truncate, capitalize, random_string, camel_case, snake_case};
//!
...
///
/// ```rust
/// use toxi_utils::string::truncate;
///
...
///
/// ```rust
/// use toxi_utils::string::capitalize;
///
/// assert_eq!(capitalize("hello"), "Hello");
...
///
/// ```rust
/// use toxi_utils::string::random_string;
///
...
///
/// ```rust
/// use toxi_utils::string::camel_case;
///
/// assert_eq!(camel_case("hello_world"), "helloWorld");
...
///
/// ```rust
/// use toxi_utils::string::snake_case;
///
