...
//!
//! ```rust
//! use toxi_utils::id::{generate_uuid, generate_id, generate_short_id};
//!
...
///
/// ```rust
/// use toxi_utils::id::generate_short_id;
///
...
///
/// ```rust
/// use toxi_utils::id::generate_numeric_id;
///
