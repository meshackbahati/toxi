...
//!
//! ```rust
//! use toxi_utils::validation::{is_email, is_url, is_phone, min_length, max_length};
//!
...
///
/// ```rust
/// use toxi_utils::validation::is_email;
///
...
///
/// ```rust
/// use toxi_utils::validation::is_url;
///
/// assert!(is_url("https://example.com"));
...
///
/// ```rust
/// use toxi_utils::validation::is_phone;
///
/// assert!(is_phone("+1234567890"));
...
///
/// ```rust
/// use toxi_utils::validation::is_alphanumeric;
///
...
///
/// ```rust
/// use toxi_utils::validation::is_numeric;
///
...
///
/// ```rust
/// use toxi_utils::validation::min_length;
///
/// assert!(min_length("hello", 3));
...
///
/// ```rust
/// use toxi_utils::validation::max_length;
///
...
///
/// ```rust
/// use toxi_utils::validation::length_between;
///
