//! # Toxi Utils
//!
//! Common utilities for the Toxi framework including string helpers,
//! date/time utilities, ID generation, and validation helpers.
//!
//! # Usage
//!
//! ```rust
//! use toxi_utils::generate_uuid;
//!
...
///
/// ```rust
/// use toxi_utils::date::{now, unix_timestamp, is_expired};
///
...
///
/// ```rust
/// use toxi_utils::id::generate_uuid;
///
/// let id = generate_uuid();
/// assert!(id.contains('-'));
/// ```
...
///
/// ```rust
/// use toxi_utils::metrics::{MetricsRegistry, RouteMetrics};
///
