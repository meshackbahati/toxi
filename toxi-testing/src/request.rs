...
use bytes::Bytes;
use serde::Serialize;
use toxi_core::types::ToxiRequest;
...
impl TestRequest {
    ...
    /// Build an Toxi request body for direct handler/router invocation.
    pub fn build_toxi(self) -> ToxiRequest {
...
mod tests {
    ...
    #[test]
    fn test_build_toxi() {
        let request = TestRequest::get("/health").build_toxi();
